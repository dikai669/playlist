...
def update_playlist(source_url, target_url, output_file):
    ...
    source_lines = load_playlist(source_url)
    target_lines = load_playlist(target_url)

    source_groups = parse_m3u(source_lines)
    target_groups = parse_m3u(target_lines)
